  ...
  const companies = await Promise.all([
    prisma.company.create({
      data: {
        type: "myCompanies",
        name: "NVIDIA",
        description: "Мировой лидер в производстве графических процессоров и технологий искусственного интеллекта",
        phone: "+123 456 78 90",
    ...
    prisma.company.create({
      data: {
        type: "partner",
        name: "Ozon",
        description: "Одна из крупнейших российских платформ электронной коммерции, предлагающая широкий ассортимент товаров",
        phone: "+098 765 43 21",
        email: "company2@example.com",
        site: "https://company2.com",
        isFavorite : true,
